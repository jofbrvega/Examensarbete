...
<section class="py-4 border-b border-gray-500 lg:py-10 ">
    <div class="splide">
        <div class="splide__track ">
            <ul class="splide__list ">
                ...
                ?>
                        <li class="flex justify-center splide__slide h-[70vh]">
                            <img class="object-fit loading=lazy" src="<?php echo $hero_slider_image['url']; ?>" alt="<?php echo $hero_slider_image['alt']; ?>">
